                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            {building.propertyType} · {building.numberOfUnits}u
                          </span>
                          {building.photos && building.photos.length > 0 && (
                            <span className="flex items-center gap-1 text-blue-600">
                              ...
                              {building.photos.length} photo{building.photos.length !== 1 ? 's' : ''}
                            </span>
                          )}
                          <span className="flex items-center gap-1 text-teal-600">
                            ...
                            {building.gpsCoordinates.latitude.toFixed(4)}, {building.gpsCoordinates.longitude.toFixed(4)}
                            {building.gpsCoordinates.accuracy && ` ±${Math.round(building.gpsCoordinates.accuracy)}m`}
                          </span>
                        </div>
                      </div>
