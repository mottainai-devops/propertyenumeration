              ...
              >
                ...
                {isExpanded && (
                  <div className="border-t border-gray-100 bg-gray-50 px-4 py-4 space-y-4">
                    ...
                    {/* Customer ID — ArcGIS-native composite: arcgisBuildingId + unitCode (v3.5.0) */}
                    {b.arcgisBuildingId && b.unitCode && (
                      <div className="bg-green-50 border border-green-200 rounded-xl px-3 py-2">
                        <p className="text-xs font-semibold text-green-700 uppercase tracking-wide mb-0.5">Customer ID</p>
                        <p className="text-sm font-mono text-green-900 font-semibold">{b.arcgisBuildingId} {b.unitCode}</p>
                        <p className="text-xs text-green-600 mt-0.5">ArcGIS-native composite identifier</p>
                      </div>
                    )}
